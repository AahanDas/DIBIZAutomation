...
public class US29_Admin_ViewEmployeeManagement extends DibizWrappers {

	@BeforeClass	
	public void setValue() {
		testCaseName = "US29_Admin_ViewEmployeeManagement";
		testDescription = "US29_Admin_ViewEmployeeManagement";
		category = "Regression";
		authors = "DrD";
		browserName = "chrome";
	...
	/*public void loginLogOut(String uName, String pwd, String partner, String Product, String Quantity) {*/
		...
		.clickOnUserLogo()
		.clickOnAdmin()
		.clickOnEmployeeManagementView()
		.verifyEmployeeManagementPage();
